...
namespace Best.HTTP.Hosts.Connections.HTTP2
{
    ...
    public sealed class HTTP2SettingsManager
    {
        ...
        {
            if (this.SettingsChangesSentAt != DateTime.MinValue && DateTime.Now - this.SettingsChangesSentAt >= this._connectionSettings.Timeout)
            {
            ...
            this.SettingsChangesSentAt = DateTime.Now;
        }
    }
}
